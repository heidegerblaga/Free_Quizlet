...
st.set_page_config(page_title='Introduction', page_icon='📝', layout="centered", initial_sidebar_state="auto", menu_items=None)
st.title('Introduction')
st.markdown(''' I love learning foreign languages. I've been interested in linguistics for as long as I can remember. 
